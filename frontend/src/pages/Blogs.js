...
const Blogs = () => {
  ...
  const [liky, setliky] = useState(<FavoriteIcon />);
  const [disliky, setdisliky] = useState(<FavoriteBorderIcon />);
  
    return (
        <>
          <Header2 />

        <Heading title_en="Blogs" title_ar="المقالات" />
          ...
          <div>
              <div className="box">
                ...
                <div className="content">
                    ...
                    <Link className="btn" to={`/blogdetail/${item.id}`}>more</Link>
                  ...
                  }}> <div className="btnslike">
                  <Button onclick="Toggle1()" id="btnh1" className="btnlike"><i class="fas fa-heart"></i></Button>
